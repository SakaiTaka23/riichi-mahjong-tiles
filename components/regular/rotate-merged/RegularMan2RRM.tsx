...
const SvgRegularMan2RRM = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    <defs>
      <mask id="Regular-Man2-r-r-m_svg__b" maskUnits="userSpaceOnUse">
        <rect
          width={300.059}
          height={400.778}
          y={652.284}
      ...
      <mask id="Regular-Man2-r-r-m_svg__c" maskUnits="userSpaceOnUse">
        <rect
          width={300.059}
          height={400.778}
          x={-451.938}
    ...
    <g transform="rotate(90 526.181 526.181)">
      ...
      <path
        ...
        mask="url(#Regular-Man2-r-r-m_svg__b)"
        style={{
          fill: "#fff",
          fillOpacity: 1,
          fillRule: "evenodd",
          ...
          strokeOpacity: 1,
          filter: "url(#Regular-Man2-r-r-m_svg__a)",
        }}
      />
      <path
        ...
        mask="url(#Regular-Man2-r-r-m_svg__c)"
        style={{
          fill: "#000",
    ...
    />
    <path
      d="M54.102 754.958c-15.912-3.454-14.93 14.041-.939 17.702 58.429 18.964 99.345-16.313 139.821-15.484 20.31 1.175 35.046 16.991 53.722 14.628 34.982-7.283 16.15-30.757-1.646-33.7-14.285-2.459-27.333-7.526-52.907-3.771-49.697 9.559-98.76 31.72-138.051 20.625M93.902 699.255c-6.437 1.433-9.592 15.777.387 17.61 34.313-.094 73.546-13.36 112.424-18.667 6.64-1.364 7.75-14.503 8.194-19.04 1.47-7.125-3.42-9.18-9.243-7.885-38.857 9.786-72.906 22.044-111.762 27.982"
      style={{
        fill: "#000",
        fillOpacity: 1,
        fillRule: "evenodd",
      ...
      transform="rotate(90 523.722 528.64)"
    />
  </svg>
);
export default SvgRegularMan2RRM;
