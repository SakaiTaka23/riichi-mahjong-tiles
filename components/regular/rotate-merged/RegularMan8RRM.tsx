...
const SvgRegularMan8RRM = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    <defs>
      <mask id="Regular-Man8-r-r-m_svg__b" maskUnits="userSpaceOnUse">
        <rect
          width={300.059}
          height={400.778}
          y={652.284}
      ...
      <mask id="Regular-Man8-r-r-m_svg__c" maskUnits="userSpaceOnUse">
        <rect
          width={300.059}
          height={400.778}
          x={-451.938}
    ...
    <g transform="rotate(90 526.181 526.181)">
      ...
      <path
        ...
        mask="url(#Regular-Man8-r-r-m_svg__b)"
        style={{
          fill: "#fff",
          fillOpacity: 1,
          fillRule: "evenodd",
          ...
          strokeOpacity: 1,
          filter: "url(#Regular-Man8-r-r-m_svg__a)",
        }}
      />
      <path
        ...
        mask="url(#Regular-Man8-r-r-m_svg__c)"
        style={{
          fill: "#000",
    ...
    />
    <path
      d="M114.076 734.853c-5.286-.854-14.806 18.767-18.705 21.301-22.082 14.124-39.34 15.368-63.567 21.646-12.721 3.366-11.36 14.218 3.418 11.816 24.397-4.908 96.5-10.341 102.984-36.951 2.054-10.196-13.81-15.183-24.13-17.812M124.63 691.126c1.763-4.84 16.214-12.947 26.27-14.505 10.2-.986 29.495 43.71 36.957 50.264 14.314 11.398 91.835 46.434 86.474 63.542-3.235 9.645-61.69-17.155-92.228-31.814-17.147-10.774-30.6-29.124-39.116-50.746-1.52-4.778-20.213-12.166-18.356-16.741"
      style={{
        fill: "#000",
        fillOpacity: 1,
        fillRule: "evenodd",
      ...
      transform="matrix(0 .92702 -1.0504 0 1092.987 15.039)"
    />
  </svg>
);
export default SvgRegularMan8RRM;
