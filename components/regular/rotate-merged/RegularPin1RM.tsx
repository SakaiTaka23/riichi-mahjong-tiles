...
const SvgRegularPin1RM = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    <defs>
      <mask id="Regular-Pin1-r-m_svg__b" maskUnits="userSpaceOnUse">
        <rect
          width={300.059}
          height={400.778}
          y={652.284}
      ...
      <mask id="Regular-Pin1-r-m_svg__c" maskUnits="userSpaceOnUse">
        <rect
          width={300.059}
          height={400.778}
          x={-451.938}
    ...
    <g transform="rotate(90 526.181 526.181)">
      ...
      <path
        ...
        mask="url(#Regular-Pin1-r-m_svg__b)"
        style={{
          fill: "#fff",
          fillOpacity: 1,
          fillRule: "evenodd",
          ...
          strokeOpacity: 1,
          filter: "url(#Regular-Pin1-r-m_svg__a)",
        }}
      />
      <path
        ...
        mask="url(#Regular-Pin1-r-m_svg__c)"
        style={{
          fill: "#000",
    ...
    <g transform="matrix(0 .89332 -.89332 0 711.331 -207.387)">
      ...
      <g transform="translate(.354)">
        ...
        <g transform="translate(-31 -64.5)">
          <use
            xlinkHref="#Regular-Pin1-r-m_svg__d"
            width="100%"
            height="100%"
      ...
      />
      <g id="Regular-Pin1-r-m_svg__f" transform="translate(-.177 .088)">
        <path
        ...
        />
        <use
          xlinkHref="#Regular-Pin1-r-m_svg__e"
          width="100%"
          height="100%"
      ...
      />
      <use
        xlinkHref="#Regular-Pin1-r-m_svg__f"
        id="Regular-Pin1-r-m_svg__g"
        width="100%"
        height="100%"
        x={0}
        y={0}
      ...
      />
      <use
        xlinkHref="#Regular-Pin1-r-m_svg__g"
        id="Regular-Pin1-r-m_svg__h"
        width="100%"
        height="100%"
        x={0}
        y={0}
      ...
      />
      <use
        xlinkHref="#Regular-Pin1-r-m_svg__h"
        id="Regular-Pin1-r-m_svg__i"
        width="100%"
        height="100%"
        x={0}
        y={0}
      ...
      />
      <use
        xlinkHref="#Regular-Pin1-r-m_svg__i"
        width="100%"
        height="100%"
        transform="rotate(-72 399.973 572.358)"
      />
...
export default SvgRegularPin1RM;
