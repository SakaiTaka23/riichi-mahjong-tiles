...
const SvgRegularMan5DoraRM = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 400 300" {...props}>
    <defs>
      <mask id="Regular-Man5-Dora-r-m_svg__b" maskUnits="userSpaceOnUse">
        <rect
          width={300.059}
          height={400.778}
          y={652.284}
      ...
      <mask id="Regular-Man5-Dora-r-m_svg__c" maskUnits="userSpaceOnUse">
        <rect
          width={300.059}
          height={400.778}
          x={-451.938}
      ...
      <filter
        id="Regular-Man5-Dora-r-m_svg__a"
        width={1.05}
        height={1.109}
        x={-0.025}
        y={-0.054}
    ...
    <g transform="rotate(90 526.181 526.181)">
      ...
      <path
        ...
        mask="url(#Regular-Man5-Dora-r-m_svg__b)"
        style={{
          fill: "#fff",
          fillOpacity: 1,
          fillRule: "evenodd",
          ...
          strokeOpacity: 1,
          filter: "url(#Regular-Man5-Dora-r-m_svg__a)",
        }}
      />
      <path
        ...
        mask="url(#Regular-Man5-Dora-r-m_svg__c)"
        style={{
          fill: "#000",
...
export default SvgRegularMan5DoraRM;
