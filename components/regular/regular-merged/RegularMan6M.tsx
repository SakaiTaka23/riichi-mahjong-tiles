...
const SvgRegularMan6M = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    <defs>
      <mask id="Regular-Man6-m_svg__b" maskUnits="userSpaceOnUse">
        <rect
          width={300.059}
          height={400.778}
          y={652.284}
      ...
      <mask id="Regular-Man6-m_svg__c" maskUnits="userSpaceOnUse">
        <rect
          width={300.059}
          height={400.778}
          x={-451.938}
    ...
    <g transform="translate(0 -652.362)">
      ...
      <path
        ...
        mask="url(#Regular-Man6-m_svg__b)"
        style={{
          fill: "#fff",
          fillOpacity: 1,
          fillRule: "evenodd",
          ...
          strokeOpacity: 1,
          filter: "url(#Regular-Man6-m_svg__a)",
        }}
      />
      <path
        ...
        mask="url(#Regular-Man6-m_svg__c)"
        style={{
          fill: "#000",
...
export default SvgRegularMan6M;
