...
const SvgRegularPin3M = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 300 400" {...props}>
    <defs>
      <mask id="Regular-Pin3-m_svg__b" maskUnits="userSpaceOnUse">
        <rect
          width={300.059}
          height={400.778}
          y={652.284}
      ...
      <mask id="Regular-Pin3-m_svg__c" maskUnits="userSpaceOnUse">
        <rect
          width={300.059}
          height={400.778}
          x={-451.938}
    ...
    <g transform="translate(0 -652.362)">
      ...
      <path
        ...
        mask="url(#Regular-Pin3-m_svg__b)"
        style={{
          fill: "#fff",
          fillOpacity: 1,
          fillRule: "evenodd",
          ...
          strokeOpacity: 1,
          filter: "url(#Regular-Pin3-m_svg__a)",
        }}
      />
      <path
        ...
        mask="url(#Regular-Pin3-m_svg__c)"
        style={{
          fill: "#000",
...
export default SvgRegularPin3M;
