...
const SvgBlackShaaM = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    <defs>
      <mask id="Black-Shaa-m_svg__b" maskUnits="userSpaceOnUse">
        <rect
          width={300.059}
          height={400.778}
          y={652.284}
      ...
      <mask id="Black-Shaa-m_svg__c" maskUnits="userSpaceOnUse">
        <rect
          width={300.059}
          height={400.778}
          x={-451.938}
    ...
    <g transform="translate(0 -652.362)">
      ...
      <path
        ...
        style={{
          ...
          strokeOpacity: 1,
          filter: "url(#Black-Shaa-m_svg__a)",
        }}
      />
      <path
