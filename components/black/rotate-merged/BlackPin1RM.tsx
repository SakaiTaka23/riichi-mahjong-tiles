...
const SvgBlackPin1RM = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    <defs>
      <mask id="Black-Pin1-r-m_svg__b" maskUnits="userSpaceOnUse">
        <rect
          width={300.059}
          height={400.778}
          y={652.284}
      ...
      <mask id="Black-Pin1-r-m_svg__c" maskUnits="userSpaceOnUse">
        <rect
          width={300.059}
          height={400.778}
          x={-451.938}
    ...
    <g transform="rotate(90 526.181 526.181)">
      ...
      <path
        ...
        mask="url(#Black-Pin1-r-m_svg__b)"
        style={{
          fill: "#fff",
          ...
          strokeOpacity: 1,
          filter: "url(#Black-Pin1-r-m_svg__a)",
        }}
      />
      <path
        ...
        mask="url(#Black-Pin1-r-m_svg__c)"
        style={{
          fill: "#000",
          fillOpacity: 1,
          fillRule: "evenodd",
      ...
      <g transform="matrix(.89332 0 0 .89332 -207.387 341.03)">
        ...
        <g transform="translate(.354)">
          ...
          <g transform="translate(-31 -64.5)">
            <use
              xlinkHref="#Black-Pin1-r-m_svg__d"
              width="100%"
              height="100%"
        ...
        />
        <g id="Black-Pin1-r-m_svg__f" transform="translate(-.177 .088)">
          <path
          ...
          />
          <use
            xlinkHref="#Black-Pin1-r-m_svg__e"
            width="100%"
            height="100%"
            style={{
              fill: "none",
        ...
        />
        <use
          xlinkHref="#Black-Pin1-r-m_svg__f"
          id="Black-Pin1-r-m_svg__g"
          width="100%"
          height="100%"
          x={0}
          y={0}
        ...
        />
        <use
          xlinkHref="#Black-Pin1-r-m_svg__g"
          id="Black-Pin1-r-m_svg__h"
          width="100%"
          height="100%"
          x={0}
          y={0}
        ...
        />
        <use
          xlinkHref="#Black-Pin1-r-m_svg__h"
          id="Black-Pin1-r-m_svg__i"
          width="100%"
          height="100%"
          x={0}
          y={0}
        ...
        />
        <use
          xlinkHref="#Black-Pin1-r-m_svg__i"
          width="100%"
          height="100%"
          transform="rotate(-72 399.973 572.358)"
        />
