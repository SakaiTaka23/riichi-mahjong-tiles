...
const SvgBlackMan7RRM = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    <defs>
      <mask id="Black-Man7-r-r-m_svg__b" maskUnits="userSpaceOnUse">
        <rect
          width={300.059}
          height={400.778}
          y={652.284}
      ...
      <mask id="Black-Man7-r-r-m_svg__c" maskUnits="userSpaceOnUse">
        <rect
          width={300.059}
          height={400.778}
          x={-451.938}
    ...
    <g transform="rotate(90 526.181 526.181)">
      ...
      <path
        ...
        mask="url(#Black-Man7-r-r-m_svg__b)"
        style={{
          fill: "#fff",
          ...
          strokeOpacity: 1,
          filter: "url(#Black-Man7-r-r-m_svg__a)",
        }}
      />
      <path
        ...
        mask="url(#Black-Man7-r-r-m_svg__c)"
        style={{
          fill: "#000",
          fillOpacity: 1,
          fillRule: "evenodd",
...
export default SvgBlackMan7RRM;
