...
const SvgBlackMan4RM = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 400 300" {...props}>
    <defs>
      <mask id="Black-Man4-r-m_svg__b" maskUnits="userSpaceOnUse">
        <rect
          width={300.059}
          height={400.778}
          y={652.284}
      ...
      <mask id="Black-Man4-r-m_svg__c" maskUnits="userSpaceOnUse">
        <rect
          width={300.059}
          height={400.778}
          x={-451.938}
    ...
    <g transform="rotate(90 526.181 526.181)">
      ...
      <path
        ...
        mask="url(#Black-Man4-r-m_svg__b)"
        style={{
          fill: "#fff",
          ...
          strokeOpacity: 1,
          filter: "url(#Black-Man4-r-m_svg__a)",
        }}
      />
      <path
        ...
        mask="url(#Black-Man4-r-m_svg__c)"
        style={{
          fill: "#000",
          fillOpacity: 1,
          fillRule: "evenodd",
